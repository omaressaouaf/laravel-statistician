...
class AggregateSourceTest extends TestCase
{
    ...
    public function it_generates_default_key(
        Aggregate $aggregate,
        string $expectedKey,
    ): void {
    ...
    {
        $source = (new AggregateSource(DB::table('users')))->keyBy('active_users');
    ...
    public function it_generates_cache_key(): void
    {
        ...
        $this->assertSame('stats:aggregate_source:users_count', $source->getCacheKey());
    }
    ...
    public function it_uses_custom_key_in_cache_key_when_key_by_is_used(): void
    {
        ...
        $this->assertSame('stats:aggregate_source:active_users', $source->getCacheKey());
    }
}
